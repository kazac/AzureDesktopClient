...
public partial class TestWSContext : DbContext
{
    public TestWSContext()
    {
    }

    public TestWSContext(DbContextOptions<TestWSContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.SystemInformationId).HasName("PK__BuildVer__35E58ECAF98B5DBF");
